...
class ReportPenerimaanController extends GetxController {
  final ReportApiService _apiService = ReportApiService();

  final String transactionType = 'FIN';
  final title = 'Laporan Penerimaan'.obs;
  ...
  Future<void> fetchTransactions() async {
    ...
    try {
      var data = await _apiService.getAllTransactions(
        ...
        transactionType: transactionType, // 'FIN'
      );
      transactionList.assignAll(data);
    } catch (e) {
      print("Error fetching penerimaan: $e");
    } finally {
