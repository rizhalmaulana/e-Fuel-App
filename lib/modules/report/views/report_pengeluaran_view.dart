          ...
          Row(
            children: [
              Container(
                ...
                // ICON BEDA: Gas Station
                child: const Icon(Icons.local_gas_station_outlined, color: AppColors.primaryOrange, size: 24),
              ),
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  // KHUSUS PENGELUARAN: Show Jumlah Pengisian Solar
                  Text("${item.jumlahPengisianSolar ?? 0} Liter", style: AppFonts.fUrbanistBold14.copyWith(color: AppColors.primaryOrange)),
                ],
              ),
              // Tombol Detail...
            ],
