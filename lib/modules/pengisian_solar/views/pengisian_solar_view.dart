...
import '../controllers/pengisian_solar_controller.dart';

class PengisianSolarView extends GetView<PengisianSolarController> {
  const PengisianSolarView({super.key});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                child: _buildDetailRow(label: 'Tanggal', value: controller.tanggal.value), // Bisa dibuat dinamis dari User Login
                              ),
                              const SizedBox(width: 20),
                              Expanded(
                                child: _buildDetailRow(label: 'No. PO', value: controller.noPO.value), // Bisa dibuat dinamis dari User Login
                              ),
                            ],
                          ),
